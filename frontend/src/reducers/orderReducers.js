...
export const orderSellerSummaryReducer = (
    state = { loading: true, summary: {} },
    action
  ) => {
    switch (action.type) {
      case ORDER_SELLER_SUMMARY_REQUEST:
        return { loading: true };
      case ORDER_SELLER_SUMMARY_SUCCESS:
        return { loading: false, summary: action.payload };
      case ORDER_SELLER_SUMMARY_FAIL:
        return { loading: false, error: action.payload };
      default:
        return state;
    }
